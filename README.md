...
Current baseline: VS Code `1.134.0`, 26,491 language-pack messages, 19,657 Danish translations
(74.20% coverage) across the core UI and 91 built-in extension resources. Run `pnpm coverage` for
the live report.
...
3. Select the generated `vscode-language-pack-da-1.0.3.vsix` file.
